...
export default function AdminFeedbackForm() {
    ...
    return (
        <div className="container mx-auto p-3">
            <h1 className="text-3xl font-bold mb-4">Admin Feedback Form</h1>
            ...
            <div className="mt-4 text-center">
                <Link to="/admin" className="text-blue-500 inline-flex items-center"><BsArrowLeft className="mr-1" />Go back to Dashboard</Link>
            </div>
        </div>
    );
}
